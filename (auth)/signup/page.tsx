// app/(auth)/signup/page.tsx - Auth Flow
'use client'
import { motion } from 'framer-motion'
import { Mail, Lock, Eye, EyeOff, Github, Google, User } from 'lucide-react'
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900/20 to-cobalt-900/30 flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-400">Join MindPilot today</p>
        </div>
